...
|---------|------|----------|
| Go | 1.25 | |
| Notiflex 이미지 | v0.3.2 (저장소 코드 기준, `main.go` 실측) / **v0.3.2 (2026-09-21 재구축 클러스터에 실제 배포된 버전, 임시 blueGreen Rollout — Valkey 연동, Kafka/OTel 비활성)** | v0.1.0→v0.1.1→v0.1.2(2026-09-21, Blue/Green 전환 데모)→v0.2.0(Valkey)→v0.2.1(CSI)→v0.3.0(Kafka)→v0.3.1(OTel)→**v0.3.2(코드 실측, health 응답 버전 문자열 기준)** |
